DROP FUNCTION IF EXISTS get_current_dashboard_word_phrases(INT);
DROP FUNCTION IF EXISTS get_unique_vocabulary_words_for_user(INT, BOOLEAN);

ALTER TABLE user_vocabulary ADD display_status INT DEFAULT 2;
ALTER TABLE user_vocabulary ADD last_updated_at TIMESTAMPTZ;
